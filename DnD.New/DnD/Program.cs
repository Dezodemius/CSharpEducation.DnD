...
namespace DnD
{
    public class Program
    {
        ...
        {   /// <summary>
            /// Обьект класса  DnDMethods
            /// </summary>
            DnDMethods dnDMethods = new DnDMethods();
            /// <summary>
            /// список предметов для добавления персонажу
            /// </summary>
            ...
            while (true)
            {
                ...
                int choice = Convert.ToInt32(Console.ReadLine());
                    switch (choice)
                    {   /// <summary>
                        /// switch case для добавления персонажа
                        /// </summary>
                        case 1:
                            ...
                            break;
                        /// <summary>
                        /// switch case для нахождения персонажа по Id
                        /// </summary>
                        case 2:
                        ...
                        /// <summary>
                        /// switch case для добавления предмета персонажу
                        /// </summary>
                        case 3:
                        ...
                        /// <summary>
                        /// switch case для отображения предметов персонажа
                        /// </summary>
                        case 4:
                        ...
                        /// <summary>
                        /// switch case для удаления предмета из инветаря персонажа
                        /// </summary>
                        case 5:
                            Console.WriteLine("Введите id персонажа:");
                        ...
                        /// <summary>
                        /// switch case создания карточки персонажа в PDF формате
                        /// </summary>
                        case 6:
                            Console.WriteLine("Введите id персонажа");
                ...
                catch (CharacterAlreadyExceprion ex)
                { 
                ...
                {
                    Console.WriteLine($"Неизвестная ошибка, нажмите любую клавишу");
                    Console.ReadKey();
                    Console.Clear();
                }
                #endregion
